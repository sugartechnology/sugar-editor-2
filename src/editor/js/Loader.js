...
import { Api as SugarApi } from "../../api/Api.js";
import { SugarModel } from "../../loader/SugarModelLoader.js";
...
function Loader(editor) {
  ...
  this.loadSugarModel = function (modelId, companyId) {
    SugarApi.fetchProduct(modelId, companyId)
      .then((data) =>
        new SugarModel().load(data, {
          forceSync: true,
          onAfterLoad: SugarModel.applyMaterials,
        })
      )
      .then((sugarModel) =>
        editor.execute(new AddSugarModelCommand(editor, sugarModel))
      );
  };
