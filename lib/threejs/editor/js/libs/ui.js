class UIElement {
	...
	init(params) { console.log(params); }
...
class UIInput extends UIElement {
	...
	constructor(text, placeholder, inputType) {
		...
		this.dom.placeholder = placeholder ? placeholder : "";
		this.dom.type = inputType ? inputType : "default";
...
class UITabbedPanelCustom extends UIDiv {
	constructor() {
...
export { UIElement, UISpan, UIDiv, UIRow, UIPanel, UIText, UIInput, UITextArea, UISelect, UICheckbox, UIColor, UINumber, UIInteger, UIBreak, UIHorizontalRule, UIButton, UIProgress, UITabbedPanel, UITabbedPanelCustom, UIListbox, ListboxItem };
