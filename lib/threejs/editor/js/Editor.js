...
Editor.prototype = {
	...
	addSugarModel: function ( sugarModel ) {
		this.clear();
		this.addObject( sugarModel.model );
	},

	removeSugarModel: function ( sugarModel ) {

		this.removeObject( sugarModel.model );
