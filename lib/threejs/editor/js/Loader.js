...
import { Api as SugarApi } from '../../../../src/api/Api.js';
import { SugarModel } from '../../../../src/loader/SugarModelLoader.js';
import { LoaderUtils } from './LoaderUtils.js';
import { AddSugarModelCommand } from './commands/AddSugarModelCommand.js';
...
function Loader( editor ) {
  ...
  this.loadSugarModel = function ( modelId, companyId ) {

    SugarApi.fetchProduct( modelId, companyId )
			.then( data =>
        new SugarModel().load( data, { forceSync: true, onAfterLoad: SugarModel.applyMaterials } )
      )
			.then( sugarModel => editor.execute( new AddSugarModelCommand( editor, sugarModel ) ) );
  }
